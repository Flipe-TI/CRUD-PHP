...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./style/css/check.css">
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.css" >
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.css">
        <script src="style/js/script.js" async defer></script>
    ...
    <body class="body">
            ...
            <ul>
              ...
              <li><a class='dropdown-arrow' href='#cadastrar'>CRUD</a>
                <ul class='sub-menus'>
                  ...
                  <li><a href='formdel.hmtl'>Delete</a></li>
                </ul>
              </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <h5>Sua operação foi concluida com sucesso!</h5>
                    <div id="here" class="here" onclick="makeOne()" title="Trigger the success animation">
                        <div class="box">
